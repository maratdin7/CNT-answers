...
# 19. Автономные системы. Внутренние и внешние протоколы маршрутизации. Характеристики протоколов маршрутизации.
...
# **20. Маршрутизация в сетях TCP/IP. Протокол маршрутизации RIP.**
...
# 21. Маршрутизация в сетях TCP/IP. Методы борьбы с петлями маршрутизации в протоколе RIP. Протокол маршрутизации RIP2.
